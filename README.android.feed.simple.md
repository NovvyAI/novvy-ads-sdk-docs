...
`NovvyAdEvent.Failed` 的 `error` 字段类型为 [`NovvyError`](android-references/types.md#novvyerror)。

[`NovvyUserContext`](android-references/types.md#novvyusercontext) 与 [`NovvyDramaRecord`](android-references/types.md#novvydramarecord) 的字段说明详见类型参考。
